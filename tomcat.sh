...
sed -i '58  a\<user username="tomcat1" password="admin@321" roles="manager-gui, manager-script"/>' apache-tomcat-11.0.22/conf/tomcat-users.xml
sed -i '511  a\</tomcat-users>' apache-tomcat-11.0.22/conf/tomcat-users.xml
